...
public class ProjetoControle {
    ...
    public String salvar(@Valid Projeto projeto, BindingResult resultado, ModelMap modelAndView) {
        if(resultado.hasErrors()){
            modelAndView.addAttribute("clientes", clienteRepositorio.findAll());
            modelAndView.addAttribute("lideres", funcionarioRepositorio.findByCargoNome("Gerente"));
            modelAndView.addAttribute("funcionarios", funcionarioRepositorio.findByCargoNomeNot("Gerente"));
